...
<title>{{ config('app.name') }} | {{ __('Sponsors') }}</title>
    <meta name="description" content="{{ __('Sponsors Description') }}" />
@endsection
...
<x-adminLayout>
    ...
    <div class="{{ $cssNs }}">
                    ...
                    @include('admin.layouts.breadcrumb', [
                        'title' => __('Sponsors'),
                        'description' => __('Sponsors Description'),
                        'breadcrum' => [
                            __('Sponsors') => '#',
                        ],
                    ])
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 d-flex justify-content-end mb-4">
                                            ...
                                            <a href="{{ route('sponsor.create') }}" class="btn btn-primary">{{ __('Sponsor') }} {{ strtolower(__('Add')) }}</a>
